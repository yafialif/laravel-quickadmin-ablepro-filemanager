...
{!! Form::open(array('files' => true, 'route' => config('quickadmin.route').'.recording.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('ustad_id', 'Ustad', array('class'=>'control-label')) !!}
    <div class="col-md-12">
        {!! Form::select('ustad_id', $ustad, old('ustad_id'), array('class'=>'form-control form-control-primary')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('id_recording', 'Id Recording', array('class'=>'control-label')) !!}
    <div class="col-md-12">
        {!! Form::text('id_recording', old('id_recording'), array('class'=>'form-control form-control-primary')) !!}
    ...
    <div class="col-md-12">
        {!! Form::text('note', old('note'), array('class'=>'form-control form-control-primary')) !!}
