        ...
        <div class="card">
            ...
            <div class="card-block">
                <div id="nestable-menu" class="m-b-10">
                    {!! link_to_route(config('quickadmin.route').'.category.create', trans('quickadmin::templates.templates-view_index-add_new') , null, array('class' => 'btn btn-success')) !!}
                </div>
                ...
                <tbody>
                    @foreach ($category as $row)
                        <tr>
                            ...
                            <td>
                                {!! link_to_route(config('quickadmin.route').'.category.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-sm btn-info')) !!}
