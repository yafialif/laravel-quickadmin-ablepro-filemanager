...
{!! Form::open(array('route' => config('quickadmin.route').'.ustad.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('id_ustad', 'ID Ustad*', array('class'=>'control-label')) !!}
    <div class="col-md-12">
        {!! Form::text('id_ustad', old('id_ustad'), array('class'=>'form-control form-control-primary')) !!}
        
    </div>
</div><div class="form-group">
    {!! Form::label('nama_ustad', 'Nama Ustad*', array('class'=>'control-label')) !!}
    <div class="col-md-12">
        {!! Form::text('nama_ustad', old('nama_ustad'), array('class'=>'form-control form-control-primary')) !!}
    ...
    <div class="col-md-12">
        {!! Form::textarea('deskripsi', old('deskripsi'), array('class'=>'form-control ckeditor')) !!}
